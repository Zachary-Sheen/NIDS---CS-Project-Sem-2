...
#region Regex Threats
        ...
        def parse_packet(packet):
            try:
                # Check if packet is an instance of a Scapy packet
        ...
        # sniff(iface= 'en0', prn = packet_handler , count = 10)
    ...
    #file parsing code - PCAP
    # def runCode():
    #     pcap_file = "/Users/zacsheen/Desktop/NIDS/test.pcap"
    ...
    #Sniffing code - en0 - set count to 0 to capture indefinitely
